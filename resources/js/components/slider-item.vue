                ...
                <div class="product">
                    <div class="product-image">
                        ...
                        <div class="product-hover-overlay"><a class="product-hover-overlay-link" :href="`/card-product/${item_data.id}`"></a>
                            <div class="product-hover-overlay-buttons"><a class="btn btn-dark btn-buy" :href="`/card-product/${item_data.id}`"><i class="fa-search fa"></i><span class="btn-buy-label ml-2">Вперед</span></a></div>
                        </div>
                    </div>
                    <div class="py-2">
