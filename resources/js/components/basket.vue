...
<div class="mb-5 row">
    <div class="col-lg-8">
        <div class="cart">
            ...
            <div v-if="basket_data!=null && !flagError">
            ...
            <div v-if="basket_data==null && flagError" class="alert alert-primary" role="alert">
                Ваша корзина пуста!
            </div>
        </div>
        <div class="my-5 d-flex justify-content-between flex-column flex-lg-row">
            <a class="btn btn-link text-muted" href="/catalog"><i class="fa fa-chevron-left"></i>Продолжить покупки</a><a class="btn btn-dark" href="/basket-place">Перейти к оформлению заказа<i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
    <div v-if="basket_data!=null" class="col-lg-4">
